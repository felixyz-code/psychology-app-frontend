...
export const AUDIT_RESOURCE_LABELS: Record<string, string> = {
  ...
  CaseFileAttachment: 'Adjunto de Expediente',
  ScheduleBlock: 'Bloqueo de Agenda',
  Patient: 'Paciente',
  Appointment: 'Cita',
...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  CLINICAL_ATTACHMENT_VIEW: 'Previsualización de Adjunto',
  CLINICAL_ATTACHMENT_DELETE: 'Eliminación de Adjunto Clínico',
  CLINICAL_APPOINTMENT_RESCHEDULED: 'Reprogramación de Cita',
  CLINICAL_SCHEDULE_BLOCK_CREATED: 'Creación de Bloqueo de Agenda',
  CLINICAL_SCHEDULE_BLOCK_DELETED: 'Eliminación de Bloqueo de Agenda',
